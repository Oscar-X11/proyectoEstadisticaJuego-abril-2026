...
public class modoDificil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        GridNumeros.setLayout(new java.awt.GridLayout(5, 5, 10, 15));
    ...
    private void AdivinarNumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdivinarNumActionPerformed
        ...
        for (int i = 0; i < COLUMNAS; i++) {
            ...
            if (Encontrado[i] == false) {
                ...
                //analizamos el digito para ver si esta en el dato ingresado
                if (NumObjetivo.contains(digIngresado)) {
                    ...
                    NumObjetivo.set(indexAmarillo, -1);//marcar para evitar duplicados
