...
public class modoFacil extends javax.swing.JFrame {
    ...
    public modoFacil() {
        ...
        //generara un arraylist con los digitos para generar los numeros aleatorios
    ...
    private void AdivinarNumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdivinarNumActionPerformed
        ...
        for (int i = 0; i < COLUMNAS; i++) {
            ...
            if (Encontrado[i] == false) {
                ...
                //analizamos el digito para ver si esta en el dato  y coincide con lo ingresado
